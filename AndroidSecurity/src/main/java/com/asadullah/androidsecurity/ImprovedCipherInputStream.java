...
public class ImprovedCipherInputStream extends FilterInputStream {
     ...
     */
    public ImprovedCipherInputStream(InputStream is, Cipher c, int bufferSize) {
        super(is);
        input = is;
        cipher = c;
     ...
     * @param c an initialized Cipher object
     */
    public ImprovedCipherInputStream(InputStream is, Cipher c) {
        super(is);
        input = is;
        cipher = c;
        ibuffer = new byte[DEFAULT_BUFFER_SIZE];
    }
     ...
     * @param is the to-be-processed input stream
     */
    protected ImprovedCipherInputStream(InputStream is) {
        super(is);
        input = is;
